...
class RegisterUseCase extends BaseUseCase<RegisterUseCaseInput, AuthenticationResponse> {
  final Repository _repository;

  RegisterUseCase(this._repository);

  @override
  Future<Either<Failure, AuthenticationResponse>> execute(RegisterUseCaseInput input) {
